...
class JwtAuthFilterTest {
    ...
    @Test
    void headerSemBearerDevePassarAdianteSemAutenticar() throws ServletException, IOException {
    ...
    @Test
    void tokenInvalidoDeveRetornar401EnaoChamarChain() throws ServletException, IOException {
        when(request.getHeader("Authorization")).thenReturn("Bearer token-quebrado");
        when(jwtService.isTokenValid("token-quebrado")).thenReturn(false);
    ...
    @Test
    void tokenValidoDeveAutenticarEPropagar() throws ServletException, IOException {
